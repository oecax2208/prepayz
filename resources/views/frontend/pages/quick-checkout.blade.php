                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
                                            ...
                                            <li class="last"  id="order_total_price">Total<span>${{number_format($after_discount,2)}}</span></li>
                                ...
                                <!--/ End Order Widget -->
                                <!-- Order Widget -->
                                <input type="hidden" name="order_id" value="{{ $product_detail->id }}" />
                                    ...
                                    <div class="content">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="cardholder_name" placeholder="" required="required">
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <div class="form-group">
                                                <label>Card Number<span>*</span></label>
                                                <input type="text" name="card_number" placeholder="" required="required">
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="expiration_month" placeholder="MM/YY" required="required">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label>Exp. Year<span>*</span></label>
                                                        <input type="text" name="expiration_year" placeholder="YYYY" required="required">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label>CVV<span>*</span></label>
                                                        <input type="text" name="card_cvv" placeholder="" required="required">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
